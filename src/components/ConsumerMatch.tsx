...
export default function ConsumerMatch({ onClose, className }: ConsumerMatchProps) {
  ...
  return (
    <div className={className}>
      ...
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-xl font-semibold text-gray-900">Find Your Financial Advisor</h2>
        {onClose && (
          <button 
            onClick={onClose}
